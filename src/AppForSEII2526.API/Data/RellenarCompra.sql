------------------------------------------------------------
-- OPCIONAL: LIMPIAR DATOS (DESCOMENTAR SI QUIERES RESETEAR)
------------------------------------------------------------
/*
...
('1', 'Lucas', 'lucas.mdn', 'Maldonado', '[]', 'C/ Costa Azul nº 14', 'España', 0,
 'lucas.mdn', 'LUCAS.MDN', 'lucas.mdn@gmail.com', 'LUCAS.MDN@GMAIL.COM', 1,
 NULL, NULL, NULL,
 '678123456', 1, 0, NULL, 1, 0),

('2', 'Elena', 'elena.rtz', 'Ruiz', '[]', 'Av. Palmera nº 6', 'España', 1,
 'elena.rtz', 'ELENA.RTZ', 'elena.ruiz@hotmail.com', 'ELENA.RUIZ@HOTMAIL.COM', 0,
 NULL, NULL, NULL,
 NULL, 0, 0, NULL, 1, 0),

('3', 'Sergio', 'sergio.gn', 'Giménez', '[]', 'C/ Prado Verde nº 21', 'España', 0,
 'sergio.gn', 'SERGIO.GN', 'sergio.gn@gmail.com', 'SERGIO.GN@GMAIL.COM', 1,
 NULL, NULL, NULL,
 '612334567', 1, 0, NULL, 1, 0),

('4', 'Laura', 'laura.blc', 'Blanco', '[]', 'C/ Camino Alto nº 9', 'España', 1,
 'laura.blc', 'LAURA.BLC', 'laura.blc@outlook.com', 'LAURA.BLC@OUTLOOK.COM', 0,
 NULL, NULL, NULL,
 NULL, 0, 0, NULL, 1, 0),

('5', 'Irene', 'irene.pns', 'Pons', '[]', 'Av. Las Flores nº 18', 'España', 0,
 'irene.pns', 'IRENE.PNS', 'irene.pns@gmail.com', 'IRENE.PNS@GMAIL.COM', 1,
 NULL, NULL, NULL,
 NULL, 0, 0, NULL, 1, 0),

('6', 'Marc', 'marc.fc', 'Ferrer', '[]', 'C/ Camino del Río nº 3', 'España', 1,
 'marc.fc', 'MARC.FC', 'marc.fc@gmail.com', 'MARC.FC@GMAIL.COM', 0,
 NULL, NULL, NULL,
 '699112233', 1, 0, NULL, 1, 0);
...
------------------------------------------------------------
-- COCHES
-- OJO: ClaseCoche debe ser ÚNICO (por índice IX_Coches_ClaseCoche)
------------------------------------------------------------
...
------------------------------------------------------------
-- COMPRAS (DATOS) -> tabla ya creada
-- Usamos variables + SCOPE_IDENTITY() para capturar los Id reales
------------------------------------------------------------
...
------------------------------------------------------------
-- DETALLE DE COMPRAS (ComprarItem)
-- Ahora usamos las variables de Id para no depender de 1..6
------------------------------------------------------------
